...
setwd("~/Desktop/Dropbox/InspectorSpaceTime/spatialStructure/datasets/HumanData/analyses/temporal/spatial/k_3")
...
movie3d(plotfunc,base1=M2,base2=M3,duration=10,dir="~/Desktop/test_spinny_pies",clean=TRUE,convert=TRUE,fps=15)
